...
# Runner: aplica os scripts 00-16 na ordem certa contra o Supabase/Postgres.
#
# USO:
...
run "17_unique_constraints.sql"
run "18_debit_idempotency.sql"
run "19_outbox_pattern.sql"
run "20_debit_idempotency_por_wallet.sql"
run "21_backfill_order_recipient.sql"
run "22_coupon_funded_by.sql"
run "23_payment_discount.sql"
run "24_delivery_region_fees.sql"
run "25_recipient_oauth.sql"
run "26_payment_split_at_origin.sql"
run "27_establishment_debts.sql"
run "28_repasse_mode.sql"
run "29_loyalty_points_unique.sql"
run "30_product_available.sql"
run "31_sponsor_bookings.sql"
run "32_rls_tabelas_sem_protecao.sql"
run "33_referrals.sql"
run "34_establishment_disabled.sql"
echo ""
