...
import (
	"github.com/carloshomar/vercardapio/auth_api/app/handlers"
...
func SetupRoutes(app *fiber.App) {
	...
	app.Get("/establishments/:id/hours", handlers.GetBusinessHours)
	app.Post("/establishments/hours", handlers.UpsertBusinessHours)
	app.Post("/establishments/hours/bulk", handlers.BulkUpdateBusinessHours)
	app.Get("/establishments/:id/is-open", handlers.CheckEstablishmentOpen)
