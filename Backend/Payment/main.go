...
func main() {
	...
	payments.Post("/:id/approve", middleware.AdminRequired(), ph.ApprovePayment)
	payments.Post("/:id/reject", middleware.AdminRequired(), ph.RejectPayment)
	...
	approvals.Put("/rules", middleware.AdminRequired(), ah.UpdateRules)
	...
	chargebacks.Post("/:id/approve", middleware.AdminRequired(), ch.ApproveChargeback)
	chargebacks.Post("/:id/reject", middleware.AdminRequired(), ch.RejectChargeback)
	...
	wallets.Post("/:user_id/credit", middleware.AdminRequired(), wh.Credit)
	wallets.Post("/:user_id/debit", middleware.AdminRequired(), wh.Debit)
	wallets.Post("/:user_id/withdraw", middleware.AdminRequired(), wh.Withdraw)
