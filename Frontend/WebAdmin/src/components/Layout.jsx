...
const menuItems = [
  ...
  { path: "/orders", label: "Pedidos", icon: FiShoppingBag },
        ...
        >
          ...
          {sidebarOpen && (
            <div className="ml-3 flex flex-col leading-none">
              <span style={{ fontSize: "18px", fontWeight: 900, color: "#EA1D2C", letterSpacing: "-0.5px", lineHeight: 1 }}>
                Fuu
              </span>
              <span style={{ fontSize: "10px", fontWeight: 700, color: "#9CA3AF", letterSpacing: "2px", textTransform: "uppercase", lineHeight: 1, marginTop: 2 }}>
                Delivery
              </span>
            </div>
          )}
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:block relative">
                <input
                  type="text"
                  placeholder="Buscar..."
                  className="w-72 pl-10 pr-4 py-2 bg-gray-100 border-none rounded-xl text-sm text-gray-700 placeholder-gray-400 focus:bg-white focus:ring-2 focus:ring-fuu-red/20 transition-all"
                />
